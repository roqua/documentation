---
title: Handmatig klaarzetten
sidebar:
  label: Handmatige metingen
  order: 2030100
---
...
Bij sommige metingen staat er nog een knop "Eigen initiatief toestaan". Daarmee geef je de respondent het recht om de geselecteerde vragenlijsten voortaan zelf op te starten.

:::note[Zie ook]
[Vragenlijsten op eigen initiatief](/docs/features/self-initiables) — wanneer deze knop verschijnt, wat de respondent ervan merkt en hoe je het recht weer intrekt.
:::
