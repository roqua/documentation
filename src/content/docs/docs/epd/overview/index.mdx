...
Indien ingesteld, zie je hier per respondent welke vragenlijsten zij op eigen initiatief kunnen invullen. Met de knop "Aanpassen" beheer je dit.

<Screenshot src="/screenshots/epd/overview_selfinit_section.png" />

:::note[Zie ook]
[Vragenlijsten op eigen initiatief](/docs/features/self-initiables) — hoe je dit recht toekent, wat de respondent ziet en wat er met de ingevulde lijsten gebeurt.
:::
