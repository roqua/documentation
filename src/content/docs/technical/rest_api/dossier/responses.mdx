...
import responsesIndexSnapshot from "@snapshots/rom/responses_index.json";
import responsesCreateSnapshot from "@snapshots/rom/responses_create.json";
import responsesUpdateSnapshot from "@snapshots/rom/responses_update.json";
...
<Snapshot json={responsesIndexSnapshot} />
...
<Snapshot json={responsesCreateSnapshot} />
...
<Snapshot json={responsesUpdateSnapshot} />
