...
A Response the set of answers to one fill out of a questionnaire. Most attributes descriptions can be found at [response endpoint](/technical/rest_api/dossier/responses/#response-attributes)
