...
* [Hourly sqlite exports](/technical/sqlite_export/download_via_api/)
...
As a starting point we describe here how to generate the csv_export as can be downloaded on [data_export/download](/technical/csv_export/download_via_api/). We start with an export_version, a description of each column in the csv, then for each response and each column we fetch the required data.
...
See [SQL Export page](/technical/sqlite_export/download_via_api/)
